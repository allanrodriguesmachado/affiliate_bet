...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form class="p-4" method="post" action="{{ route('commission.store') }}">
                @csrf
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="amount" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Valor</label>
                            ...
                            <input type="text" name="amount" id="amount"
                                   ...
                                   placeholder="O valor deve começar com '+' ou '-' seguido de números. Pode incluir até duas casas decimais."
                                   pattern="^[+-]\d+(\.\d{1,2})?$"
                                   title="O valor deve começar com '+' ou '-' seguido de números. Pode incluir até duas casas decimais." />
                    ...
                    <div>
                        ...
                        <x-input-error :messages="$errors->get('commission_created_at')" class="mt-2"/>
